        ...
        <div class="col-xl-8 col-lg-10">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('admin.diadiem.store') }}" method="POST" id="formThemDiaDiem">
                        @csrf
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-select form-select-lg @error('TrangThai') is-invalid @enderror" id="TrangThai" name="TrangThai">
                                            <option value="KhaDung" {{ old('TrangThai', 'KhaDung') == 'KhaDung' ? 'selected' : '' }}>
                                                ✓ Khả dụng
                                            </option>
                                            <option value="TamNgung" {{ old('TrangThai') == 'TamNgung' ? 'selected' : '' }}>
                                                ✕ Tạm ngưng
                                            </option>
                                        </select>
                                        @error('TrangThai')
