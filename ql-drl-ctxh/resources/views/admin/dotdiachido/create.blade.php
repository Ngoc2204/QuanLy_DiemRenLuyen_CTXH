        ...
        <div class="col-lg-8 mx-auto">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.dotdiachido.store') }}" 
                          method="POST" 
                          id="createDotForm">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select form-select-lg @error('TrangThai') is-invalid @enderror" 
                                    id="TrangThai" 
                                    name="TrangThai">
                                <option value="SapDienRa" {{ old('TrangThai', 'SapDienRa') == 'SapDienRa' ? 'selected' : '' }}>
                                    🟡 Sắp diễn ra
                                </option>
                                <option value="DangDienRa" {{ old('TrangThai') == 'DangDienRa' ? 'selected' : '' }}>
                                    🟢 Đang diễn ra
                                </option>
                                <option value="DaKetThuc" {{ old('TrangThai') == 'DaKetThuc' ? 'selected' : '' }}>
                                    ⚫ Đã kết thúc
                                </option>
                            </select>
                            @error('TrangThai')
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="{{ route('admin.dotdiachido.index') }}" class="btn btn-outline-secondary btn-lg px-4">
