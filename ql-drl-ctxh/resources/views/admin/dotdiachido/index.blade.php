...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center my-4">
        ...
        <a href="{{ route('admin.dotdiachido.create') }}" class="btn btn-primary px-4 py-2 shadow-sm">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold">{{ $dots->total() }}</h3>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold">{{ $dots->where('TrangThai', 'DangDienRa')->count() }}</h3>
                        </div>
                        <div class="text-white-50">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold">{{ $dots->where('TrangThai', 'SapDienRa')->count() }}</h3>
                        </div>
                        <div class="text-white-50">
        ...
        <div class="card-header bg-white py-3 border-bottom">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-light text-dark border">
                    Hiển thị {{ $dots->count() }} / {{ $dots->total() }} đợt
                </span>
            </div>
        </div>
                    ...
                    <tbody>
                        @forelse ($dots as $index => $item)
                            <tr class="border-bottom">
                                <td class="px-4 py-3">
                                    <span class="badge bg-light text-dark border">{{ $dots->firstItem() + $index }}</span>
                                </td>
                                <td class="px-4 py-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="mb-0 fw-semibold">{{ $item->TenDot }}</h6>
                                            {{-- TODO: Thêm link đến trang chi tiết --}}
                                            {{-- <a href="{{ route('admin.dotdiachido.show', $item->id) }}" class="text-decoration-none">
                                                {{ $item->TenDot }}
                                            </a> --}}
                                        </div>
                                    </div>
                                ...
                                <td class="px-4 py-3">
                                    <span class="text-muted">
                                        ...
                                        {{ \Carbon\Carbon::parse($item->NgayBatDau)->format('d/m/Y') }}
                                    </span>
                                </td>
                                <td class="px-4 py-3">
                                    <span class="text-muted">
                                        <i class="fas fa-calendar text-success me-1"></i>
                                        {{ \Carbon\Carbon::parse($item->NgayKetThuc)->format('d/m/Y') }}
                                    </span>
                                </td>
                                <td class="px-4 py-3">
                                ...
                                <td class="px-4 py-3 text-center">
                                    <div class="btn-group" role="group">
                                        <!-- Nút Sửa -->
                                        <a href="{{ route('admin.dotdiachido.edit', $item->id) }}" 
                                        ...
                                        <!-- Nút Xóa -->
                                        <form action="{{ route('admin.dotdiachido.destroy', $item->id) }}" 
                                              method="POST" 
                                              class="d-inline" 
                ...
                <div class="card-footer bg-white border-top py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="text-muted small">
                            Hiển thị {{ $dots->firstItem() }} - {{ $dots->lastItem() }} trong tổng số {{ $dots->total() }} đợt
                        </div>
                        <div>
                            {{ $dots->links() }}
                        </div>
