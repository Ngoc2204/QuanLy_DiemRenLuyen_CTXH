...
@section('page_title', 'Thêm giảng viên mới') {{-- Thêm page_title nếu layout của bạn sử dụng --}}
...
<style>
    ...
    :root {
        ...
        --success: #10b981; /* Sử dụng màu success cho nút Lưu */
    ...
    /* Sử dụng màu xanh lá (success) cho nút Lưu */
    .btn-success-modern {
...
<div class="page-wrapper">
    ...
    <nav class="breadcrumb-modern">
        ...
        <span class="active">Thêm giảng viên mới</span>
    </nav>
            ...
            <div class="form-card-header-content">
                <div class="form-card-title">
                    ...
                    <div class="form-card-title-text">
                        ...
                        <p>Nhập thông tin chi tiết để tạo hồ sơ giảng viên mới</p>
                    </div>
                </div>
                {{-- Nút quay lại --}}
        ...
        <div class="form-card-body">
            ...
            <div class="form-info-box">
                ...
                <div class="form-info-box-content">
                    <p>Lưu ý khi thêm giảng viên mới:</p>
                    <ul>
                        <li>**Mã giảng viên** là duy nhất và bắt buộc.</li>
            ...
            <form action="{{ route('admin.giangvien.store') }}" method="POST">
                    ...
                    <div class="form-group-modern">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" 
                                   ...
                                   name="MaGV" 
                                   value="{{ old('MaGV') }}"
                                   class="form-control-modern @error('MaGV') is-invalid @enderror"
                        ...
                        <div class="input-hint">
                            ...
                            Mã giảng viên là trường duy nhất.
                        </div>
                        @enderror
                    </div>
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <select id="GioiTinh" 
                                name="GioiTinh"
                                class="form-select-modern @error('GioiTinh') is-invalid @enderror" 
                                required>
                ...
                <div class="form-actions">
                    ...
                    {{-- Nút Lưu --}}
                    <button type="submit" class="btn-modern btn-success-modern"> {{-- Đổi màu nút Lưu thành xanh lá --}}
