...
@section('page_title', 'Thêm học kỳ mới')
...
<div class="page-wrapper">
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            ...
            <!-- Form -->
            <form action="{{ route('admin.hocky.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" 
                               ...
                               name="MaHocKy" 
                               value="{{ old('MaHocKy') }}"
                               class="form-control-modern @error('MaHocKy') is-invalid @enderror" 
                            ...
                            @if (isset($namhocs))
                                @foreach($namhocs as $nh)
                                    <option value="{{ $nh->MaNamHoc }}" 
                                        {{ old('MaNamHoc') == $nh->MaNamHoc ? 'selected' : '' }}>
                                        {{ $nh->TenNamHoc }}
                                    </option>
                                @endforeach
                            @endif
