...
<div class="page-wrapper">
    ...
    <nav class="breadcrumb-modern">
        {{-- Giả định route index là 'admin.khoa.index' --}}
        <a href="{{ route('admin.khoa.index') }}">
            <i class="fa-solid fa-building-columns"></i>
            Quản lý khoa
        </a>
        <span class="separator">/</span>
        {{-- Giả định biến $khoa được truyền từ Controller --}}
        <span class="active">Chỉnh sửa: {{ $khoa->TenKhoa }}</span>
    </nav>
    ...
    <div class="form-card">
            ...
            <div class="form-card-header-content">
                <div class="form-card-title">
                    ...
                    <div class="form-card-title-text">
                        ...
                        <p>Cập nhật thông tin cho khoa: {{ $khoa->TenKhoa }}</p>
                    </div>
                </div>
                <a href="{{ route('admin.khoa.index') }}" class="btn-back-modern">
        ...
        <div class="form-card-body">
            ...
            <!-- Form -->
            {{-- Giả định route update là 'admin.khoa.update' và dùng $khoa->MaKhoa --}}
            <form action="{{ route('admin.khoa.update', $khoa->MaKhoa) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" 
                               id="TenKhoa" 
                               name="TenKhoa" 
                               value="{{ old('TenKhoa', $khoa->TenKhoa) }}"
                               class="form-control-modern @error('TenKhoa') is-invalid @enderror" 
                ...
                <div class="form-actions">
                    <a href="{{ route('admin.khoa.index') }}" class="btn-modern btn-secondary-modern">
