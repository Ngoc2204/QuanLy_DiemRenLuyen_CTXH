...
<div class="container-fluid">
    ...
    <div class="main-card">
        ...
        <div class="card-header-modern">
            ...
            <a href="{{ route('admin.khoa.create') }}" class="btn-modern btn-primary-modern">
        ...
        <div class="search-section">
            <form method="GET" action="{{ route('admin.khoa.index') }}" class="search-form">
                ...
                <a href="{{ route('admin.khoa.index') }}" class="btn-reset">
            ...
            <table class="table-modern">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="fw-semibold">{{ $khoa->TenKhoa }}</td>
                        <td>
                            <div class="action-buttons">
                                <a href="{{ route('admin.khoa.edit', $khoa->MaKhoa) }}" 
                                   class="btn-action-modern btn-edit" 
                                   title="Chỉnh sửa">
                                    <i class="fa-solid fa-pen"></i>
                                </a>
                                <form action="{{ route('admin.khoa.destroy', $khoa->MaKhoa) }}" 
                                      method="POST" 
                                      class="d-inline"
        ...
        <div class="pagination-wrapper">
            {{ $khoas->appends(request()->query())->links('pagination::bootstrap-5') }}
        </div>
        @endif
    </div>
</div>
