...
@section('page_title', 'Chỉnh sửa lớp')
...
<div class="page-wrapper">
    ...
    <nav class="breadcrumb-modern">
        ...
        {{-- Giả định biến $lop được truyền từ Controller --}}
        <span class="active">Chỉnh sửa: {{ $lop->TenLop }}</span>
    </nav>
    ...
    <div class="form-card">
            ...
            <div class="form-card-header-content">
                <div class="form-card-title">
                    ...
                    <div class="form-card-title-text">
                        <h1>Chỉnh sửa lớp</h1>
                        <p>Cập nhật thông tin cho lớp: {{ $lop->TenLop }}</p>
                    </div>
                </div>
        ...
        <div class="form-card-body">
            ...
            <!-- Form -->
            {{-- Giả định route update là 'admin.lop.update' và dùng $lop->MaLop --}}
            <form action="{{ route('admin.lop.update', $lop->MaLop) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" 
                               id="TenLop" 
                               name="TenLop" 
                               {{-- Dùng old() để giữ lại giá trị nếu validation fail --}}
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        <select id="MaKhoa"
                            ...
                            {{-- Giả định biến $khoas chứa danh sách các khoa --}}
                            @if (isset($khoas))
                                @foreach($khoas as $khoa)
                                    <option value="{{ $khoa->MaKhoa }}" 
                                        {{-- Chọn giá trị cũ (nếu có lỗi) hoặc giá trị hiện tại của $lop --}}
                                        {{ old('MaKhoa', $lop->MaKhoa) == $khoa->MaKhoa ? 'selected' : '' }}>
