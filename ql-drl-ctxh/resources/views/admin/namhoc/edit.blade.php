...
@section('title', 'Chỉnh sửa năm học')
@section('page_title', 'Chỉnh sửa năm học')
...
<div class="page-wrapper">
    ...
    <nav class="breadcrumb-modern">
        <a href="{{ route('admin.namhoc.index') }}">
            <i class="fa-solid fa-calendar-days"></i>
            Quản lý năm học
        </a>
        <span class="separator">/</span>
        {{-- Giả định biến $namhoc được truyền từ Controller --}}
        <span class="active">Chỉnh sửa: {{ $namhoc->TenNamHoc }}</span>
    </nav>
    ...
    <div class="form-card">
            ...
            <div class="form-card-header-content">
                <div class="form-card-title">
                    ...
                    <div class="form-card-title-text">
                        ...
                        <p>Cập nhật thông tin cho năm học: {{ $namhoc->TenNamHoc }}</p>
                    </div>
                </div>
                <a href="{{ route('admin.namhoc.index') }}" class="btn-back-modern">
        ...
        <div class="form-card-body">
            ...
            <!-- Form -->
            {{-- Giả định route update là 'admin.namhoc.update' và dùng $namhoc->MaNamHoc --}}
            <form action="{{ route('admin.namhoc.update', $namhoc->MaNamHoc) }}" method="POST">
                @csrf
                @method('PUT')
                
                {{-- MaNamHoc là khóa chính auto-increment, không cần hiển thị --}}
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" 
                               id="TenNamHoc" 
                               name="TenNamHoc" 
                               value="{{ old('TenNamHoc', $namhoc->TenNamHoc) }}"
                               class="form-control-modern @error('TenNamHoc') is-invalid @enderror" 
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="date" 
                               id="NgayBatDau" 
                               name="NgayBatDau" 
                               value="{{ old('NgayBatDau', $namhoc->NgayBatDau) }}"
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="date" 
                               id="NgayKetThuc" 
                               name="NgayKetThuc" 
                               value="{{ old('NgayKetThuc', $namhoc->NgayKetThuc) }}"
                ...
                <div class="form-actions">
                    <a href="{{ route('admin.namhoc.index') }}" class="btn-modern btn-secondary-modern">
