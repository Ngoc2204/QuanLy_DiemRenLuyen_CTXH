...
@section('page_title', 'Cập nhật thông tin nhân viên')
            ...
            <div class="form-card-header-content">
                <div class="form-card-title">
                    ...
                    <div class="form-card-title-text">
                        ...
                        <p>Điều chỉnh thông tin cho: {{ $nhanvien->TenNV }}</p>
                    </div>
                </div>
        ...
        <div class="form-card-body">
            ...
            <form action="{{ route('admin.nhanvien.update', $nhanvien->MaNV) }}" method="POST">
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" 
                                       ...
                                       class="form-control-modern @error('TenNV') is-invalid @enderror"
                    ...
                    <div class="col-md-4">
                        <div class="form-group-modern">
                            ...
                            <select name="GioiTinh" id="GioiTinh"
                                class="form-control-modern @error('GioiTinh') is-invalid @enderror" required>
                ...
                <div class="form-actions">
                    <a href="{{ route('admin.nhanvien.index') }}" class="btn-modern btn-secondary-modern">
