...
@section('page_title', 'Thông tin nhân viên')
            ...
            <div class="profile-card-header-content">
                <div class="profile-card-title">
                    <div class="profile-card-icon">
                        <!-- Avatar -->
                        <img src="https://ui-avatars.com/api/?name={{ urlencode($nhanvien->TenNV) }}&background=fff&color=4f46e5&font-size=0.4&bold=true"
                            alt="Avatar của {{ $nhanvien->TenNV }}">
                    </div>
                ...
                <a href="{{ route('admin.nhanvien.index') }}" class="btn-back-modern">
        ...
        <div class="profile-card-body">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">
                        {!! $nhanvien->Email ? $nhanvien->Email : '<span class="empty">—</span>' !!}
                    </div>
                </div>
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">
                        {!! $nhanvien->SDT ? $nhanvien->SDT : '<span class="empty">—</span>' !!}
                    </div>
                </div>
            </div>
