...
@section('page_title', 'Chi tiết sinh viên')
            ...
            <div class="profile-card-header-content">
                <div class="profile-card-title">
                    <div class="profile-card-icon">
                        <!-- Avatar -->
                        <img src="https://ui-avatars.com/api/?name={{ urlencode($sinhvien->HoTen) }}&background=fff&color=4f46e5&font-size=0.4&bold=true" 
                             alt="Avatar của {{ $sinhvien->HoTen }}">
                    </div>
        ...
        <div class="profile-card-body">
            ...
            <div class="info-grid">
                <div class="info-item">
                    ...
                    <div class="info-value">
                        {{ \Carbon\Carbon::parse($sinhvien->NgaySinh)->format('d/m/Y') }}
                    </div>
                </div>
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">
                        {!! $sinhvien->Email ? $sinhvien->Email : '<span class="empty">—</span>' !!}
                    </div>
                </div>
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">
                        {!! $sinhvien->SDT ? $sinhvien->SDT : '<span class="empty">—</span>' !!}
                    </div>
                </div>
            ...
            <div class="info-grid">
                <div class="info-item">
                    ...
                    <div class="info-value">
                        {!! $sinhvien->lop->khoa->TenKhoa ?? '<span class="empty">—</span>' !!}
                    </div>
                </div>
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">
                        {!! $sinhvien->lop->TenLop ?? '<span class="empty">—</span>' !!}
                    </div>
                </div>
