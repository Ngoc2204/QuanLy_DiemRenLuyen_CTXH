...
@section('title', 'Xem điểm CTXH')
@section('page_title', 'Xem điểm CTXH')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="filter-card">
                <form method="GET" action="{{ route('giangvien.lop.diem_ctxh') }}" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-lg-4">
                            ...
                            @if($selectedLop)
                                <a href="{{ route('giangvien.lop.diem_ctxh') }}" class="btn btn-light w-100 mt-2">
                ...
                @forelse ($sinhviens as $index => $sv)
                    ...
                    @endif
                                <tr class="table-row">
                                    ...
                                    <td class="text-center">
                                        <span class="score-badge {{ $sv->TongDiem >= 80 ? 'score-high' : ($sv->TongDiem >= 60 ? 'score-medium' : 'score-low') }}">
                                            {{ $sv->TongDiem ?? 0 }}
                                        </span>
                                    </td>
                                </tr>
                ...
                @empty
                    <div class="empty-state-container">
                        <div class="empty-state">
                            ...
                            @if($selectedLop)
                                <a href="{{ route('giangvien.lop.diem_ctxh') }}" class="btn btn-sm btn-outline-primary mt-3">
