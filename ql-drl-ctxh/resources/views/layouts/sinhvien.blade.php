...
<body>
        ...
        <div class="header-container">
            ...
            <div class="header-right">
                ...
                <div class="user-menu" id="user-menu">
                    ...
                    <ul class="dropdown">
                        <li><a href="{{ route('sinhvien.profile.show') }}"><i class="fa-solid fa-user"></i> Thông tin cá nhân</a></li>
                        <li><a href="{{ route('sinhvien.thongtin_sinhvien.password_edit') }}"><i class="fa-solid fa-key"></i> Đổi mật khẩu</a></li>
    ...
    <aside class="left-menu" id="left-menu">
        <ul class="menu-list">
            <li class="menu-item">
                <a href="{{ route('sinhvien.home') }}" class="menu-link active">
