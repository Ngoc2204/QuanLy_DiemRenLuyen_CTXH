    ...
    <div class="col-md-3 animate-fade-in" style="animation-delay: 0.1s">
        <div class="stats-card primary">
            <div class="card-body text-center p-4">
                ...
                <div class="stats-value">{{ number_format($tongSinhVien ?? 0) }}</div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 animate-fade-in" style="animation-delay: 0.2s">
        <div class="stats-card success">
            <div class="card-body text-center p-4">
                ...
                <div class="stats-value">{{ number_format($tongHoatDongDRL ?? 0) }}</div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 animate-fade-in" style="animation-delay: 0.3s">
        <div class="stats-card warning">
            <div class="card-body text-center p-4">
                ...
                <div class="stats-value">{{ number_format($tongHoatDongCTXH ?? 0) }}</div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 animate-fade-in" style="animation-delay: 0.4s">
        <div class="stats-card danger">
            <div class="card-body text-center p-4">
                ...
                <div class="stats-value">{{ number_format($tongThongBao ?? 0) }}</div>
            </div>
        </div>
    </div>
...
<div class="animate-fade-in" style="animation-delay: 0.7s">
    <div class="notification-card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            @if(isset($thongBaoMoi) && count($thongBaoMoi) > 0)
                <span class="badge-new">{{ count($thongBaoMoi) }} mới</span>
            @endif
        </div>
        <div class="card-body p-4">
                ...
                <div class="notification-item d-flex align-items-start">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="notification-time">
                            ...
                            {{-- Giả sử 'created_at' là đối tượng Carbon --}}
                            @if($tb->created_at instanceof \Carbon\Carbon)
...
<script>
    ...
    new Chart(ctxDRL, {
        ...
        data: {
            ...
            labels: {!! json_encode($labelsDRL ?? ['Hoàn thành', 'Chưa hoàn thành']) !!},
            datasets: [{
                // Lấy data từ controller
                data: {!! json_encode($dataDRL ?? [0, 0]) !!},
                backgroundColor: [
    ...
    new Chart(ctxCTXH, {
        type: 'doughnut',
        data: {
            labels: {!! json_encode($labelsCTXH ?? ['Hoàn thành', 'Chưa hoàn thành']) !!},
            datasets: [{
                data: {!! json_encode($dataCTXH ?? [0, 0]) !!},
                backgroundColor: [
