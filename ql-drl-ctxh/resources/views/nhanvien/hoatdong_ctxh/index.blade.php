    ...
    <div class="card-header bg-gradient d-flex justify-content-between align-items-center py-3" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li>
                    <a class="dropdown-item" href="{{ route('nhanvien.hoatdong_ctxh.create') }}">
                        <i class="fa-solid fa-hand-holding-heart me-2 text-primary" style="width:20px;"></i>
                        Thêm HĐ Thường (Lẻ)
                    </a>
                </li>
                <li>
                    {{-- Cần có route này trong routes/web.php --}}
                    <a class="dropdown-item" href="{{ route('nhanvien.create_batch') }}">
