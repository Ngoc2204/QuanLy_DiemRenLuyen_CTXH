        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-light">
                        <h6 class="mb-0 text-dark"><i class="fa-solid fa-users me-2 text-primary"></i>Danh sách Sinh viên Đăng ký <span class="badge bg-primary ms-2">{{ $sinhVienCount }}</span></h6>
                    </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body text-center">
                        @if($hoatdong_ctxh->CheckInToken || $hoatdong_ctxh->CheckOutToken)
                        <div class="row g-3">
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body d-grid gap-2">
                        <a href="{{ route('nhanvien.hoatdong_ctxh.ghi_nhan_ket_qua', $hoatdong_ctxh) }}"
                            class="btn btn-info w-100 mb-2">
                            <i class="fa-solid fa-marker me-2"></i> Ghi nhận/Điều chỉnh Kết quả
                        </a>

                        {{-- Nút tạo Check-In QR --}}
                        <a href="{{ route('nhanvien.hoatdong_ctxh.create_checkin_qr', $hoatdong_ctxh) }}" class="btn btn-success w-100">
                            <i class="fa-solid fa-arrow-right-to-bracket me-2"></i> Phát Mã QR Check-In
                        </a>

                        {{-- Nút tạo Check-Out QR --}}
                        <a href="{{ route('nhanvien.hoatdong_ctxh.create_checkout_qr', $hoatdong_ctxh) }}" class="btn btn-warning text-white w-100">
                        ...
                        <a href="{{ route('nhanvien.hoatdong_ctxh.edit', $hoatdong_ctxh) }}" class="btn btn-outline-warning">
