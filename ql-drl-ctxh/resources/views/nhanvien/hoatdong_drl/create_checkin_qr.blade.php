...
@section('title', 'Tạo Mã QR Check-In DRL')
...
<div class="grid-container">
    ...
    <div class="info-card">
        ...
        <div class="card-body">
            ...
            @if($hoatdong_drl->CheckInToken && $hoatdong_drl->CheckInOpenAt && $hoatdong_drl->CheckInExpiresAt)
                <div class="qr-status-alert active">
                    ...
                    <div class="qr-status-alert-content">
                        ...
                        <div class="qr-status-alert-text">
                            <strong>Hiệu lực:</strong> {{ $hoatdong_drl->CheckInOpenAt->format('H:i - d/m/Y') }} 
                            đến {{ $hoatdong_drl->CheckInExpiresAt->format('H:i - d/m/Y') }}
                        </div>
                    </div>
                </div>
            @endif
    ...
    <div class="form-card">
        ...
        <div class="card-body">
            <form action="{{ route('nhanvien.hoatdong_drl.generate_checkin_qr', $hoatdong_drl) }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" 
                           name="CheckInOpenAt" 
                           class="form-control"
                           value="{{ old('CheckInOpenAt', $hoatdong_drl->ThoiGianBatDau ? $hoatdong_drl->ThoiGianBatDau->format('Y-m-d\TH:i') : '') }}"
                           required>
                    @error('CheckInOpenAt')
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" 
                           ...
                           class="form-control"
                           value="{{ old('CheckInExpiresAt', $hoatdong_drl->ThoiGianKetThuc ? $hoatdong_drl->ThoiGianKetThuc->format('Y-m-d\TH:i') : '') }}"
                           required>
