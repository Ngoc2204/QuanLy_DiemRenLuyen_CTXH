                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <h4 class="mb-0 text-primary">{{ number_format($tongHoatDong) }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <h4 class="mb-0 text-success">{{ number_format($tongDangKy) }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <h4 class="mb-0 text-info">{{ $tyLeLopDay }}%</h4>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="small text-primary mt-1">
                                                ...
                                                {{ $hd->giangVienPhuTrach->TenGV ?? 'Chưa gán' }}
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-center">
                                    ...
                                    <div class="progress" style="height: 8px;">
                                        <div class="progress-bar {{ $tyLe >= 80 ? 'bg-danger' : ($tyLe >= 50 ? 'bg-warning' : 'bg-success') }}" role="progressbar" style="width: {{ $tyLe }}%;" aria-valuenow="{{ $tyLe }}" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content border-0 shadow">
                                                ...
                                                <div class="modal-footer"><button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i class="fa-solid fa-xmark me-1"></i>Hủy</button>
                                                    <form action="{{ route('nhanvien.hoatdong_drl.destroy', $hd->MaHoatDong) }}" method="POST" style="display: inline;">@csrf @method('DELETE')<button type="submit" class="btn btn-danger"><i class="fa-solid fa-trash-can me-1"></i>Xóa</button></form>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
