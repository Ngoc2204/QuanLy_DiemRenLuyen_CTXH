                ...
                <div class="tab-pane fade show active" id="profile" role="tabpanel">
                    <div class="card profile-card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('nhanvien.profile.update') }}" method="POST" enctype="multipart/form-data" id="profileForm">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="avatar-section">
                                    <div class="text-center">
                                        ...
                                        <img id="avatarPreview" 
                                             src="{{ $avatarPath ?? 'https://ui-avatars.com/api/?name=' . urlencode(old('TenNV', optional($nhanvien)->TenNV ?? $user->TenDangNhap)) . '&background=fff&color=4f46e5&size=150' }}" 
                                             alt="Avatar" 
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input type="file" name="avatar" accept="image/*" class="d-none @error('avatar') is-invalid @enderror" id="avatarInput">
                                        </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="TenNV" class="form-control @error('TenNV') is-invalid @enderror" value="{{ old('TenNV', optional($nhanvien)->TenNV ?? $user->TenDangNhap) }}" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="GioiTinh" class="form-select">
                                            ...
                                            <option value="Nam" {{ old('GioiTinh', optional($nhanvien)->GioiTinh) == 'Nam' ? 'selected' : '' }}>Nam</option>
                                            <option value="Nữ" {{ old('GioiTinh', optional($nhanvien)->GioiTinh) == 'Nữ' ? 'selected' : '' }}>Nữ</option>
                                            <option value="Khác" {{ old('GioiTinh', optional($nhanvien)->GioiTinh) == 'Khác' ? 'selected' : '' }}>Khác</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" name="Email" class="form-control @error('Email') is-invalid @enderror" value="{{ old('Email', optional($nhanvien)->Email) }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="SDT" class="form-control @error('SDT') is-invalid @enderror" value="{{ old('SDT', optional($nhanvien)->SDT) }}">
                ...
                <div class="tab-pane fade" id="password" role="tabpanel">
                    <div class="card profile-card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('nhanvien.profile.update_password') }}" method="POST">
                                @csrf
            ...
            <div class="card info-card">
                ...
                <div class="card-body">
                    <p>
                        ...
                        <span style="font-size: 1.1rem;">{{ $user->TenDangNhap }}</span>
                    </p>
                    <p>
                        <strong>Vai trò</strong><br>
                        <span class="badge bg-light text-dark px-3 py-2" style="font-size: 0.9rem;">
                            <i class="fa-solid fa-user-tie me-1"></i> {{ $user->VaiTro }}
                        </span>
                    </p>
                    <hr>
                    <small class="opacity-75">
                        <i class="fa-solid fa-fingerprint me-1"></i> ID: {{ $user->TenDangNhap }}
                    </small>
                </div>
            </div>
