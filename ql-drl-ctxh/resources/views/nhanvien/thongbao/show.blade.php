...
@section('page_title', 'Chi tiết Phản hồi Sinh viên')
...
<div class="container-fluid px-4">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-3">
                <div>
                    <h4 class="mb-1">
                        <i class="fa-solid fa-circle-info text-primary me-2"></i>Chi tiết Phản hồi #{{ $thongbao->MaPhanHoi }}
                    </h4>
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('nhanvien.thongbao.edit', $thongbao->MaPhanHoi) }}" class="btn btn-primary">
    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
                            ...
                            <div class="info-item">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 fw-semibold">{{ $thongbao->sinhvien->HoTen ?? 'Không tìm thấy thông tin SV' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="info-item">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 fw-semibold">{{ $thongbao->MSSV }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 fw-semibold">
                                            {{ $thongbao->NgayGui ? \Carbon\Carbon::parse($thongbao->NgayGui)->format('d/m/Y') : 'N/A' }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="info-item">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 fw-semibold">
                                            {{ $thongbao->NgayGui ? \Carbon\Carbon::parse($thongbao->NgayGui)->format('H:i:s') : 'N/A' }}
                                        </p>
                                    </div>
                                </div>
                            </div>
            ...
            {{-- Additional Notes (nếu có) --}}
            {{-- @if($thongbao->GhiChuPhanHoi)
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-warning bg-opacity-10 border-0 py-3">
                    <h5 class="mb-0">
                        <i class="fa-solid fa-sticky-note text-warning me-2"></i>Ghi chú xử lý
                    </h5>
                </div>
                <div class="card-body p-4">
                    <div class="notes-content">
                        {!! nl2br(e($thongbao->GhiChuPhanHoi)) !!}
                    </div>
                </div>
            </div>
            @endif --}}
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        <a href="{{ route('nhanvien.thongbao.index') }}" class="btn btn-outline-secondary btn-lg px-4">
                            <i class="fa-solid fa-arrow-left me-2"></i>Quay lại danh sách
                        </a>
                        <div class="d-flex gap-2">
                            <a href="{{ route('nhanvien.thongbao.edit', $thongbao->MaPhanHoi) }}" class="btn btn-primary btn-lg px-4">
                                <i class="fa-solid fa-pen-to-square me-2"></i>Cập nhật trạng thái
                            </a>
                            @if($thongbao->TrangThai == 'Đã phản hồi')
