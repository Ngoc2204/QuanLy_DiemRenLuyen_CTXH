...
<div class="container-fluid" style="max-width:1400px;margin:0 auto;padding:2rem 1rem;">
    ...
    {{-- (Thông báo Success/Error/Validation giữ nguyên) --}}
    @if (session('success'))
    ...
    {{-- === SỬA: CẬP NHẬT COUNT CHO TAB CTXH === --}}
    ...
    <div class="tab-content" id="activityTabContent">
        ...
        <div class="tab-pane fade show active" id="drl-content" role="tabpanel" aria-labelledby="drl-tab">
            ...
            <div class="activity-card drl-card"
                ...
                data-semester="{{ optional($activity->hocKy)->TenHocKy ?? 'N/A' }}">
                ...
                <div class="activity-footer">
                    ...
                    <div style="display: flex; gap: 10px;">
                        ...
                        @else
                        <form action="{{ route('sinhvien.dangky.drl', $activity->MaHoatDong) }}" method="POST" style="margin:0; flex: 1;">
                            @csrf
