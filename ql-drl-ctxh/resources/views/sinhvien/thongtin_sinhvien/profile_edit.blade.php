...
<div class="row justify-content-center">
    <div class="col-lg-12 col-xl-11">
        ...
        <div class="page-header-card">
            <a href="{{ route('sinhvien.profile.show') }}" class="back-button">
        ...
        <!-- Main Form Card -->
        <div class="edit-card">
            <form action="{{ route('sinhvien.profile.update') }}" method="POST" enctype="multipart/form-data" id="studentProfileForm">
                @csrf
                @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12">
                            <div class="form-group-custom">
                                ...
                                <div class="input-readonly">
                                    <span>{{ $student->lop->TenLop ?? $student->MaLop }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group-custom">
                                ...
                                <div class="input-wrapper">
                                    <input type="text"
                                        id="SDT"
                                        name="SDT"
                                        class="form-control-custom @error('SDT') is-invalid @enderror"
                                        value="{{ old('SDT', $student->SDT) }}"
                            ...
                            <div class="form-group-custom">
                                ...
                                <div class="avatar-upload-section">
                                    <div class="avatar-preview-container">
                                        ...
                                        <div class="avatar-preview-wrapper">
                                            <img id="avatarPreview" 
                                                 src="{{ $avatarUrl ?? 'https://ui-avatars.com/api/?name=' . urlencode($student->HoTen) . '&background=667eea&color=fff&size=150' }}" 
                                                 alt="Avatar">
                                    ...
                                    <input type="file" 
                                           name="avatar" 
                                           accept="image/*" 
                                           class="form-control-custom @error('avatar') is-invalid @enderror" 
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('sinhvien.profile.show') }}" class="btn-cancel">
