...
<?php $__env->startSection('title', 'Chỉnh sửa sinh viên'); ?>
<?php $__env->startSection('page_title', 'Cập nhật thông tin sinh viên'); ?>
...
<div class="page-wrapper">
    ...
    <div class="form-card">
            ...
            <div class="form-card-header-content">
                <div class="form-card-title">
                    ...
                    <div class="form-card-title-text">
                        ...
                        <p>Điều chỉnh thông tin cho: <?php echo e($sinhvien->HoTen); ?></p>
                    </div>
                </div>
        ...
        <div class="form-card-body">
            ...
            <form action="<?php echo e(route('admin.sinhvien.update', $sinhvien->MSSV)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" 
                                       ...
                                       value="<?php echo e($sinhvien->MSSV); ?>"
                                       readonly>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" 
                                       id="HoTen" 
                                       name="HoTen" 
                                       value="<?php echo e(old('HoTen', $sinhvien->HoTen)); ?>"
                                       class="form-control-modern <?php $__errorArgs = ['HoTen'];
                    ...
                    <div class="col-md-4">
                        <div class="form-group-modern">
                            ...
                            <input type="date" 
                                   id="NgaySinh"
                                   name="NgaySinh"
                                   value="<?php echo e(old('NgaySinh', $sinhvien->NgaySinh)); ?>"
                                   class="form-control-modern <?php $__errorArgs = ['NgaySinh'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                    ...
                    <div class="col-md-4">
                        <div class="form-group-modern">
                            <label for="GioiTinh" class="form-label-modern">
                             ...
                             <select name="GioiTinh" id="GioiTinh" class="form-control-modern <?php $__errorArgs = ['GioiTinh'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="Nam" <?php echo e(old('GioiTinh', $sinhvien->GioiTinh) == 'Nam' ? 'selected' : ''); ?>>Nam</option>
                                <option value="Nữ" <?php echo e(old('GioiTinh', $sinhvien->GioiTinh) == 'Nữ' ? 'selected' : ''); ?>>Nữ</option>
                                <option value="Khác" <?php echo e(old('GioiTinh', $sinhvien->GioiTinh) == 'Khác' ? 'selected' : ''); ?>>Khác</option>
                            </select>
                         ...
                         <div class="form-group-modern">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="email" 
                                       id="Email" 
                                       name="Email" 
                                       value="<?php echo e(old('Email', $sinhvien->Email)); ?>"
                         ...
                         <div class="form-group-modern">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" 
                                       id="SDT" 
                                       name="SDT" 
                                       value="<?php echo e(old('SDT', $sinhvien->SDT)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group-modern">
                            ...
                            <select name="MaLop" id="MaLop" class="form-control-modern <?php $__errorArgs = ['MaLop'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <?php $__currentLoopData = $lops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($lop->MaLop); ?>" <?php echo e(old('MaLop', $sinhvien->MaLop) == $lop->MaLop ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" 
                                       id="Khoa" 
                                       class="form-control-modern" 
                                       value="<?php echo e($sinhvien->lop->khoa->TenKhoa ?? 'Vui lòng chọn lớp'); ?>"
                                       readonly>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-actions">
                    <a href="<?php echo e(route('admin.sinhvien.index')); ?>" class="btn-modern btn-secondary-modern">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/admin/sinhvien/edit.blade.php ENDPATH**/ ?>