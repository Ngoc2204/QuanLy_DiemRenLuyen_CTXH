...
<?php $__env->startSection('title', 'Lịch Hoạt Động Tuần'); ?>
...
<div class="schedule-wrapper">
  <div class="schedule-container">
    ...
    <div class="schedule-header">
      ...
      <div class="week-info">
        Tuần: <?php echo e($startOfWeek->format('d/m')); ?> - <?php echo e($endOfWeek->format('d/m/Y')); ?>
    ...
    <div class="schedule-grid">
      ...
      <?php $__currentLoopData = $daysOfWeek; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="day-col">
          ...
          <div
            class="day-header <?php echo e($dayData['date']->isToday() ? 'today' : ''); ?>"
            style="grid-row:1;grid-column:<?php echo e($col); ?>;"
          >
          ...
          <?php $__currentLoopData = $slots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row => $slotItems): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="class-cell" style="grid-row:<?php echo e($row); ?>;grid-column:<?php echo e($col); ?>;">
              <?php $__currentLoopData = $slotItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                  /** @var \App\Models\HoatDong $activity */
                  $activity     = $item['hoatdong'];
                ...
                <div class="class-card <?php echo e($cardClass); ?> <?php echo e($hasActionsClass); ?>">
                  <span class="class-type-badge"><?php echo e($item['type']); ?></span>

                  <div class="class-name"><?php echo e($activity->TenHoatDong); ?></div>
                  <div class="class-code"><?php echo e($statusText); ?></div>

                  <div class="class-time">
                    <i class="fas fa-clock"></i>
                    <?php echo e($activity->ThoiGianBatDau->format('H:i')); ?> -
                    <?php echo e($activity->ThoiGianKetThuc->format('H:i')); ?>
                  ...
                  <?php if($showActions): ?>
                    <div class="class-actions">
                      <?php if(! $isCheckedIn): ?>
                        <a
                          href="<?php echo e(route('sinhvien.scan.camera') . '?token=' . urlencode($activity->CheckInToken ?? '')); ?>"
                      ...
                      <?php else: ?>
                        <a
                          href="<?php echo e(route('sinhvien.scan.camera') . '?token=' . urlencode($activity->CheckOutToken ?? '')); ?>"
