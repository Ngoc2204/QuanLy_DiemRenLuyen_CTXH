...
<?php $__env->startSection('page_title', 'Thêm giảng viên mới'); ?> 
...
<div class="page-wrapper">
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            ...
            <!-- Form -->
            <form action="<?php echo e(route('admin.giangvien.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group-modern">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" 
                                   id="MaGV" 
                                   name="MaGV" 
                                   value="<?php echo e(old('MaGV')); ?>"
                                   class="form-control-modern <?php $__errorArgs = ['MaGV'];
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/admin/giangvien/create.blade.php ENDPATH**/ ?>