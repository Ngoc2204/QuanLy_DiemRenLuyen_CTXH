...
<?php $__env->startSection('title', 'Xem điểm Rèn Luyện'); ?>
<?php $__env->startSection('page_title', 'Xem điểm Rèn Luyện'); ?>
                ...
                <div class="header-stats">
                    <div class="stat-box">
                        ...
                        <div class="stat-info">
                            ...
                            <span class="stat-value">HK<?php echo e($selectedHocKy); ?></span>
                        </div>
                    </div>
                    <div class="stat-box">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="filter-card">
                <form method="GET" action="<?php echo e(route('giangvien.lop.diem_drl')); ?>" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-lg-2 col-md-12 d-flex gap-2">
                            ...
                            <?php if($selectedLop): ?>
                                <a href="<?php echo e(route('giangvien.lop.diem_drl', ['hoc_ky' => $selectedHocKy])); ?>" class="btn btn-light" title="Reset lớp">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $sinhviens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $sv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" style="width: 16%;">
                                        <span class="table-header-text">Điểm HK<?php echo e($selectedHocKy); ?></span>
                                    </th>
                                    <th class="text-center" style="width: 16%;">
                    ...
                    <?php endif; ?>
                                <tr class="table-row">
                                    ...
                                    <td class="text-center">
                                        <span class="score-badge <?php echo e($sv->TongDiem >= 80 ? 'score-high' : ($sv->TongDiem >= 60 ? 'score-medium' : ($sv->TongDiem >= 40 ? 'score-low' : 'score-critical'))); ?>">
                                    ...
                                    <td class="text-center">
                                        <?php if($sv->XepLoai): ?>
                                            <span class="xep-loai-badge xep-loai-<?php echo e(strtolower($sv->XepLoai)); ?>">
                                                <?php echo e($sv->XepLoai); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="empty-state-container">
                        <div class="empty-state">
                            ...
                            <?php if($selectedLop): ?>
                                <a href="<?php echo e(route('giangvien.lop.diem_drl', ['hoc_ky' => $selectedHocKy])); ?>" class="btn btn-sm btn-outline-primary mt-3">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.giangvien', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/giangvien/lop/diem_drl.blade.php ENDPATH**/ ?>