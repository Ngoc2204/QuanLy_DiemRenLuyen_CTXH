...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Hệ thống Nghiệp vụ - Nhân viên'); ?></title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('nhanvien.home')); ?>" class="<?php echo e(request()->routeIs('nhanvien.home') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('nhanvien.thongbao.index')); ?>" class="<?php echo e(request()->routeIs('nhanvien.thongbao*') ? 'active' : ''); ?>">
                <i class="fa-solid fa-bullhorn"></i>
                <span>Quản lý Thông báo</span>
            </a>

            <a href="<?php echo e(route('nhanvien.hoatdong_ctxh.index')); ?>" class="<?php echo e(request()->routeIs('nhanvien.hoatdong_ctxh*') ? 'active' : ''); ?>"> 
                <i class="fa-solid fa-hand-holding-heart"></i>
                <span>Hoạt động CTXH</span>
            </a>

            <a href="<?php echo e(route('nhanvien.hoatdong_drl.index')); ?>" class="<?php echo e(request()->routeIs('nhanvien.hoatdong_drl*') ? 'active' : ''); ?>">
                <i class="fa-solid fa-clipboard-check"></i>
                <span>Hoạt động DRL</span>
            </a>

            <a href="<?php echo e(route('nhanvien.duyet_dang_ky.index')); ?>" class="<?php echo e(request()->routeIs('nhanvien.duyetsinhvien*') ? 'active' : ''); ?>">
...
</html><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/layouts/nhanvien.blade.php ENDPATH**/ ?>