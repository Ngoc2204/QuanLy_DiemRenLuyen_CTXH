    ...
    <header class="header">
        <div class="header-container">
            ...
            <div class="header-right">
                ...
                <a href="<?php echo e(route('sinhvien.news.index')); ?>" class="nav-link notification">
        ...
        <ul class="menu-list">
            ...
            <li class="menu-item has-child">
                ...
                <ul class="menu-child">
                    ...
                    <li><a href="<?php echo e(route('sinhvien.academics.show')); ?>">Thông tin học tập</a></li>
                    <li><a href="<?php echo e(route('sinhvien.graduation.show')); ?>">Đề xuất tốt nghiệp</a></li>
                </ul>
            </li>
            ...
            <li class="menu-item has-child">
                ...
                <ul class="menu-child">
                    <li><a href="<?php echo e(route('sinhvien.diem_cong_tac_xa_hoi')); ?>">Kết quả tham gia</a></li>
                    <li><a href="#">Trạng thái hoạt động đã đăng ký</a></li>
