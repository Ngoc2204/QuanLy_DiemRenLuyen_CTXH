...
<?php $__env->startSection('title', 'Chọn lớp cố vấn'); ?>
<?php $__env->startSection('page_title', 'Gán lớp cố vấn'); ?> 
            ...
            <div class="form-card-header-content">
                <div class="form-card-title">
                    ...
                    <div class="form-card-title-text">
                        ...
                        <p>Gán lớp cố vấn cho: <?php echo e($giangvien->TenGV); ?></p>
                    </div>
                </div>
        ...
        <div class="form-card-body">
            ...
            <div class="form-info-box">
                ...
                <div class="form-info-box-content">
                    Chọn các lớp mà giảng viên <strong><?php echo e($giangvien->TenGV); ?></strong> sẽ làm cố vấn học tập. Bạn có thể chọn nhiều lớp.
                </div>
            </div>

            <form action="<?php echo e(route('admin.giangvien.assign.post', $giangvien->MaGV)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group-modern">
                    ...
                    <div class="checkbox-grid">
                        <?php $__empty_1 = true; $__currentLoopData = $lops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <label class="form-check-modern"> 
                            <input class="form-check-input-modern"
                                   type="checkbox"
                                   name="lop[]"
                                   value="<?php echo e($lop->MaLop); ?>"
                                   <?php echo e($giangvien->lopPhuTrach->contains($lop->MaLop) ? 'checked' : ''); ?>>
                            <span class="form-check-label-modern"><?php echo e($lop->TenLop); ?></span>
                        </label>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/admin/giangvien/assign.blade.php ENDPATH**/ ?>