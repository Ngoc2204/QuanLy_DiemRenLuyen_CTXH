...
<?php $__env->startSection('title', 'Thêm Hoạt động DRL'); ?>
<?php $__env->startSection('page_title', 'Thêm mới Hoạt động DRL'); ?>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-select" id="MaGV" name="MaGV">
                                ...
                                <option value="<?php echo e($maGV); ?>" <?php echo e(old('MaGV') == $maGV ? 'selected' : ''); ?>>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control"
                                ...
                                name="MoTa"
                                rows="4"
                                placeholder="Nhập mô tả chi tiết về hoạt động..." required><?php echo e(old('MoTa')); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-select" id="MaHocKy" name="MaHocKy" required>
                                ...
                                <option value="<?php echo e($maHK); ?>" <?php echo e(old('MaHocKy') == $maHK ? 'selected' : ''); ?>>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.nhanvien', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/nhanvien/hoatdong_drl/create.blade.php ENDPATH**/ ?>