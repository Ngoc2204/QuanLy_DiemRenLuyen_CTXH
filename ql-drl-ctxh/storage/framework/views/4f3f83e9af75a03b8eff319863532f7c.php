...
<?php $__env->startSection('title', 'Báo cáo & Xuất file'); ?>
<?php $__env->startSection('page_title', 'Báo cáo & Xuất file'); ?>
...
<?php if($selectedLop && $selectedHocKy): ?>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="stats-card">
            ...
            <div class="stats-content">
                ...
                <div class="stats-value"><?php echo e($sinhviens->total()); ?></div>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6">
        <div class="stats-card">
            ...
            <div class="stats-content">
                ...
                <div class="stats-value">
                    <?php echo e(number_format($sinhviens->avg(fn($sv) => $sv->diemRenLuyen->first()->TongDiem ?? 0), 1)); ?>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="stats-card">
            ...
            <div class="stats-content">
                ...
                <div class="stats-value">
                    <?php echo e(number_format($sinhviens->avg(fn($sv) => $sv->diemCtxh->TongDiem ?? 0), 1)); ?>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="stats-card">
            ...
            <div class="stats-content">
                ...
                <div class="stats-value">
                    <?php echo e($sinhviens->filter(fn($sv) => optional($sv->diemRenLuyen->first())->XepLoai == 'Xuất sắc')->count()); ?>
...
<div class="card modern-card">
    ...
    <div class="card-body p-4">
        <form method="GET" action="<?php echo e(route('giangvien.lop.baocao')); ?>">
            <div class="row g-3">
                ...
                <div class="col-lg-4 col-md-12">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('giangvien.lop.baocao.export', request()->query())); ?>" 
                           class="btn btn-success flex-fill modern-btn <?php echo e((!$selectedLop || !$selectedHocKy) ? 'disabled' : ''); ?>" 
                           onclick="return <?php echo e((!$selectedLop || !$selectedHocKy) ? 'false' : 'true'); ?>"
                           title="<?php echo e((!$selectedLop || !$selectedHocKy) ? 'Vui lòng chọn lớp và học kỳ trước' : 'Xuất báo cáo Excel'); ?>">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
            ...
            <div class="d-flex gap-2 align-items-center">
                <span class="badge bg-primary-subtle text-primary px-3 py-2">
                    <i class="fa-solid fa-school me-1"></i><?php echo e($selectedLop); ?>

                </span>
                <span class="badge bg-success-subtle text-success px-3 py-2">
                    <i class="fa-solid fa-calendar me-1"></i>HK: <?php echo e($selectedHocKy); ?>

                </span>
                <span class="badge bg-info-subtle text-info px-3 py-2">
                    <i class="fa-solid fa-users me-1"></i><?php echo e($sinhviens->total()); ?> SV
                </span>
            </div>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    <tr class="table-row-hover">
                        <td class="text-center">
                            <div class="index-badge"><?php echo e($sinhviens->firstItem() + $index); ?></div>
                        </td>
                        <td>
                        ...
                        <td class="text-center">
                            <div class="score-badge score-drl">
                                <div class="score-value"><?php echo e($tongDiemDRL); ?></div>
                                <div class="score-label">điểm</div>
                            </div>
                        </td>
                        <td class="text-center">
                            <?php if($diemDRL && $diemDRL->XepLoai): ?>
                                <?php
                                ...
                                ?>
                                <span class="rank-badge <?php echo e($badgeClass); ?>">
                                    <?php if($xepLoai == 'Xuất sắc'): ?>
                                        <i class="fa-solid fa-crown me-1"></i>
                                    <?php elseif($xepLoai == 'Tốt'): ?>
                        ...
                        <td class="text-center">
                            <div class="score-badge score-ctxh">
                                <div class="score-value"><?php echo e($tongDiemCTXH); ?></div>
                                <div class="score-label">điểm</div>
                            </div>
                        </td>
                    </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.giangvien', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/giangvien/lop/baocao.blade.php ENDPATH**/ ?>