...
<?php $__env->startSection('title', 'Thống kê điểm CTXH'); ?>
<?php $__env->startSection('page_title', 'Thống kê Cộng Tác Xã Hội'); ?>
...
<div class="container-fluid">
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e(number_format($tongSinhVien)); ?></div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e(number_format($sinhVienChuaCoHoatDong)); ?></div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e(number_format($tongHoatDong)); ?></div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo e(number_format($tongDiem)); ?></div>
        </div>
    </div>
    ...
    <div class="chart-card">
        ...
        <table class="table-custom">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $diemTrungBinhByLop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $lop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td>
                        <?php if($key == 0): ?>
                        ...
                        <?php else: ?>
                            <span class="badge-rank" style="background: var(--gray-100); color: var(--dark);"><?php echo e($key + 1); ?></span>
                        <?php endif; ?>
                    </td>
                    <td>
                        <strong><?php echo e($lop->TenLop); ?></strong>
                    </td>
                    <td><?php echo e(number_format($lop->sinhVien)); ?></td>
                    <td>
                        <strong style="color: var(--primary);"><?php echo e(number_format($lop->soLanThamGia)); ?></strong>
                    </td>
                </tr>
...
<script>
    ...
    const diemRanges = <?php echo json_encode($diemRanges); ?>;
    ...
    // Biểu đồ hoạt động theo tháng
    const ctxhByMonth = <?php echo json_encode(array_values($ctxhByMonth)); ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/admin/thongke/ctxh.blade.php ENDPATH**/ ?>