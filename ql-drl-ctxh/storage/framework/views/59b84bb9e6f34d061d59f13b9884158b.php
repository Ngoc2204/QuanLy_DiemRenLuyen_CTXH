        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-light">
                        <h6 class="mb-0 text-dark"><i class="fa-solid fa-users me-2 text-primary"></i>Danh sách Sinh viên Đăng ký <span class="badge bg-primary ms-2"><?php echo e($sinhVienCount); ?></span></h6>
                    </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body text-center">
                        <?php if($hoatdong_ctxh->CheckInToken || $hoatdong_ctxh->CheckOutToken): ?>
                        <div class="row g-3">
                            ...
                            <div class="col-6">
                                ...
                                <button class="btn btn-sm btn-outline-primary mt-2 w-100" onclick="showQRModal('checkin', '<?php echo e(route('sinhvien.scan', ['token' => $hoatdong_ctxh->CheckInToken])); ?>', '<?php echo e($hoatdong_ctxh->TenHoatDong); ?>')">
                            ...
                            <?php if($hoatdong_ctxh->CheckOutToken): ?>
                            <div class="col-6">
                                ...
                                <button class="btn btn-sm btn-outline-primary mt-2 w-100" onclick="showQRModal('checkout', '<?php echo e(route('sinhvien.scan', ['token' => $hoatdong_ctxh->CheckOutToken])); ?>', '<?php echo e($hoatdong_ctxh->TenHoatDong); ?>')">
                                    <i class="fa-solid fa-expand me-1"></i>Phóng to
                                </button>
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body d-grid gap-2">
                        <a href="<?php echo e(route('nhanvien.hoatdong_ctxh.ghi_nhan_ket_qua', $hoatdong_ctxh)); ?>"
                            class="btn btn-info w-100 mb-2">
                            <i class="fa-solid fa-marker me-2"></i> Ghi nhận/Điều chỉnh Kết quả
                        </a>

                        
                        <a href="<?php echo e(route('nhanvien.hoatdong_ctxh.create_checkin_qr', $hoatdong_ctxh)); ?>" class="btn btn-success w-100">
                            <i class="fa-solid fa-arrow-right-to-bracket me-2"></i> Phát Mã QR Check-In
                        </a>

                        
                        <a href="<?php echo e(route('nhanvien.hoatdong_ctxh.create_checkout_qr', $hoatdong_ctxh)); ?>" class="btn btn-warning text-white w-100">
                        ...
                        <a href="<?php echo e(route('nhanvien.hoatdong_ctxh.edit', $hoatdong_ctxh)); ?>" class="btn btn-outline-warning">
