...
<?php $__env->startSection('title', 'Cập nhật Trạng thái Phản hồi'); ?>
<?php $__env->startSection('page_title', 'Cập nhật Trạng thái Phản hồi'); ?>
        ...
        <div class="col-lg-8 mx-auto">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white border-bottom py-3">
                    <h5 class="mb-0">
                        <i class="fa-solid fa-info-circle me-2 text-primary"></i>Thông tin Phản hồi #<?php echo e($thongbao->MaPhanHoi); ?>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-4 pb-3 border-bottom">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h6 class="mb-0"><?php echo e($thongbao->sinhvien->HoTen ?? 'Không tìm thấy thông tin SV'); ?></h6>
                                <small class="text-muted">MSSV: <?php echo e($thongbao->MSSV); ?></small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4 pb-3 border-bottom">
                        ...
                        <p class="mb-0 fw-semibold">
                            ...
                            <?php echo e($thongbao->NgayGui ? \Carbon\Carbon::parse($thongbao->NgayGui)->format('d/m/Y H:i:s') : 'N/A'); ?>
                        ...
                        <div>
                            <?php if($thongbao->TrangThai == 'Chưa xử lý'): ?>
                                <span class="badge bg-danger-subtle text-danger border border-danger px-3 py-2">
                                    <i class="fa-solid fa-circle-exclamation me-1"></i><?php echo e($thongbao->TrangThai); ?>

                                </span>
                            <?php elseif($thongbao->TrangThai == 'Đang xử lý'): ?>
                                <span class="badge bg-warning-subtle text-warning border border-warning px-3 py-2">
                                    <i class="fa-solid fa-spinner me-1"></i><?php echo e($thongbao->TrangThai); ?>

                                </span>
                            <?php else: ?>
                                <span class="badge bg-success-subtle text-success border border-success px-3 py-2">
                                    <i class="fa-solid fa-circle-check me-1"></i><?php echo e($thongbao->TrangThai); ?>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    <form action="<?php echo e(route('nhanvien.thongbao.update', $thongbao->MaPhanHoi)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    name="TrangThai" 
                                    required>
                                <option value="Chưa xử lý" <?php echo e(old('TrangThai', $thongbao->TrangThai) == 'Chưa xử lý' ? 'selected' : ''); ?>>
                                    🔴 Chưa xử lý
                                </option>
                                <option value="Đang xử lý" <?php echo e(old('TrangThai', $thongbao->TrangThai) == 'Đang xử lý' ? 'selected' : ''); ?>>
                                    🟡 Đang xử lý
                                </option>
                                <option value="Đã phản hồi" <?php echo e(old('TrangThai', $thongbao->TrangThai) == 'Đã phản hồi' ? 'selected' : ''); ?>>
                                    🟢 Đã phản hồi
                                </option>
                            </select>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const originalStatus = '<?php echo e($thongbao->TrangThai); ?>';
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.nhanvien', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/nhanvien/thongbao/edit.blade.php ENDPATH**/ ?>