            ...
            <div class="form-card-header-content">
                <div class="form-card-title">
                    ...
                    <div class="form-card-title-text">
                        ...
                        <p>Tạo một học kỳ mới cho hệ thống</p>
                    </div>
                </div>
        ...
        <div class="form-card-body">
            ...
            <div class="form-info-box">
                ...
                <div class="form-info-box-content">
                    <p>Hãy nhập đầy đủ thông tin cho học kỳ mới:</p>
                    <ul>
                        <li>Mã học kỳ (là khóa chính, ví dụ: HK1_2425)</li>
                        <li>Tên học kỳ rõ ràng (ví dụ: Học kỳ 1 - Năm học 2024-2025)</li>
...
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <?php else: ?>
                        <div class="input-hint">
                            ...
                            Mã học kỳ phải là duy nhất trong hệ thống
                        </div>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php if(isset($namhocs)): ?>
                                <?php $__currentLoopData = $namhocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($nh->MaNamHoc); ?>" 
                                        <?php echo e(old('MaNamHoc') == $nh->MaNamHoc ? 'selected' : ''); ?>>
