...
<?php $__env->startSection('page_title', 'Thêm học kỳ mới'); ?>
...
<div class="page-wrapper">
    ...
    <nav class="breadcrumb-modern">
        <a href="<?php echo e(route('admin.hocky.index')); ?>">
            
            <i class="fa-solid fa-calendar-week"></i>
            Quản lý học kỳ
        </a>
        <span class="separator">/</span>
        <span class="active">Thêm học kỳ mới</span>
    </nav>
            ...
            <div class="form-card-header-content">
                <div class="form-card-title">
                    ...
                    <div class="form-card-title-text">
                        ...
                        <p>Nhập thông tin để tạo học kỳ mới trong hệ thống</p>
                    </div>
                </div>
                <a href="<?php echo e(route('admin.hocky.index')); ?>" class="btn-back-modern">
        ...
        <div class="form-card-body">
            ...
            <div class="form-info-box">
                ...
                <div class="form-info-box-content">
                    <p>Lưu ý khi thêm học kỳ mới:</p>
                    <ul>
                        
                        <li>Mã học kỳ phải là duy nhất (ví dụ: "HK1_2425")</li>
                        <li>Học kỳ cần phải thuộc về một Năm học</li>
            ...
            <!-- Form -->
            <form action="<?php echo e(route('admin.hocky.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text"
                            id="MaHocKy"
                            name="MaHocKy"
                            value="<?php echo e(old('MaHocKy')); ?>"
                            class="form-control-modern <?php $__errorArgs = ['MaHocKy'];
...
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div class="input-hint">
                        ...
                        Mã học kỳ là duy nhất, ví dụ: HK1_2425 (Học kỳ 1 năm 2024-2025)
                    </div>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text"
                            id="TenHocKy"
                            name="TenHocKy"
                            value="<?php echo e(old('TenHocKy')); ?>"
                            class="form-control-modern <?php $__errorArgs = ['TenHocKy'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        <select id="MaNamHoc"
                            name="MaNamHoc"
                            class="form-control-modern form-select-modern <?php $__errorArgs = ['MaNamHoc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <option value="<?php echo e($nh->MaNamHoc); ?>" <?php echo e(old('MaNamHoc') == $nh->MaNamHoc ? 'selected' : ''); ?>>
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="date"
                            ...
                            class="form-control-modern <?php $__errorArgs = ['NgayBatDau'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div class="input-hint">
                        <i class="fa-solid fa-circle-info"></i>
                        Ngày bắt đầu của học kỳ (chọn đúng theo năm học)
                    </div>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="date"
                            ...
                            class="form-control-modern <?php $__errorArgs = ['NgayKetThuc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-actions">
                    <a href="<?php echo e(route('admin.hocky.index')); ?>" class="btn-modern btn-secondary-modern">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/admin/hocky/create.blade.php ENDPATH**/ ?>