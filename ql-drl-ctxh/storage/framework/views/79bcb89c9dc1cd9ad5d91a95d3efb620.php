...
<?php $__env->startSection('page_title', 'Cập nhật thông tin nhân viên'); ?>
...
<div class="page-wrapper">
    <nav class="breadcrumb-modern">
        ...
        <span class="active">Cập nhật nhân viên</span>
    </nav>
            ...
            <div class="form-card-header-content">
                <div class="form-card-title">
                    ...
                    <div class="form-card-title-text">
                        ...
                        <p>Điều chỉnh thông tin cho: <?php echo e($nhanvien->TenNV); ?></p>
                    </div>
                </div>
        ...
        <div class="form-card-body">
            ...
            <div class="form-info-box">
                ...
                <div class="form-info-box-content">
                    <ul>
                        <li>Trường <strong>Mã nhân viên</strong> không thể thay đổi.</li>
                        <li>Các trường có dấu <span class="required-mark">*</span> là bắt buộc.</li>
                    </ul>
                </div>
            </div>

            <form action="<?php echo e(route('admin.nhanvien.update', $nhanvien->MaNV)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" 
                                       ...
                                       value="<?php echo e($nhanvien->MaNV); ?>" 
                                       readonly>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" 
                                       id="TenNV" 
                                       name="TenNV"
                                       value="<?php echo e(old('TenNV', $nhanvien->TenNV)); ?>"
                    ...
                    <div class="col-md-4">
                        <div class="form-group-modern">
                            ...
                            <select name="GioiTinh" id="GioiTinh"
                                class="form-control-modern <?php $__errorArgs = ['GioiTinh'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="Nam" <?php echo e(old('GioiTinh', $nhanvien->GioiTinh) == 'Nam' ? 'selected' : ''); ?>>Nam</option>
                                <option value="Nữ" <?php echo e(old('GioiTinh', $nhanvien->GioiTinh) == 'Nữ' ? 'selected' : ''); ?>>Nữ</option>
                                <option value="Khác" <?php echo e(old('GioiTinh', $nhanvien->GioiTinh) == 'Khác' ? 'selected' : ''); ?>>Khác</option>
                            </select>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="text" 
                                       id="SDT" 
                                       name="SDT"
                                       value="<?php echo e(old('SDT', $nhanvien->SDT)); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/admin/nhanvien/edit.blade.php ENDPATH**/ ?>