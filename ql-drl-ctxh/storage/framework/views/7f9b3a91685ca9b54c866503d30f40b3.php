...
<?php $__env->startSection('page_title', 'Chỉnh sửa lớp'); ?>
...
<div class="page-wrapper">
    ...
    <nav class="breadcrumb-modern">
        <a href="<?php echo e(route('admin.lop.index')); ?>">
            <i class="fa-solid fa-users-line"></i>
            Quản lý lớp
        </a>
        <span class="separator">/</span>
        
        <span class="active">Chỉnh sửa: <?php echo e($lop->TenLop); ?></span>
    </nav>
            ...
            <div class="form-card-header-content">
                <div class="form-card-title">
                    ...
                    <div class="form-card-title-text">
                        <h1>Chỉnh sửa lớp</h1>
                        <p>Cập nhật thông tin cho lớp: <?php echo e($lop->TenLop); ?></p>
                    </div>
                </div>
                <a href="<?php echo e(route('admin.lop.index')); ?>" class="btn-back-modern">
        ...
        <div class="form-card-body">
            ...
            <div class="form-info-box">
                ...
                <div class="form-info-box-content">
                    <p>Lưu ý khi cập nhật lớp:</p>
                    <ul>
                        <li>Mã lớp (là khóa chính) không thể thay đổi</li>
            ...
            <form action="<?php echo e(route('admin.lop.update', $lop->MaLop)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-hint">
                        ...
                        Mã lớp là khóa chính và không thể thay đổi.
                    </div>
                </div>
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" 
                               ...
                               value="<?php echo e(old('TenLop', $lop->TenLop)); ?>"
                               class="form-control-modern <?php $__errorArgs = ['TenLop'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        <select id="MaKhoa"
                                name="MaKhoa"
                                class="form-control-modern form-select-modern <?php $__errorArgs = ['MaKhoa'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php if(isset($khoas)): ?>
                                <?php $__currentLoopData = $khoas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $khoa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($khoa->MaKhoa); ?>" 
                                        
                                        <?php echo e(old('MaKhoa', $lop->MaKhoa) == $khoa->MaKhoa ? 'selected' : ''); ?>>
                                        <?php echo e($khoa->TenKhoa); ?> (<?php echo e($khoa->MaKhoa); ?>)
                                    </option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-actions">
                    <a href="<?php echo e(route('admin.lop.index')); ?>" class="btn-modern btn-secondary-modern">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/admin/lop/edit.blade.php ENDPATH**/ ?>