...
<?php $__env->startSection('title', 'Thanh toán QR Code'); ?>
...
<div class="container-fluid">
    <div class="payment-card">
        <div class="payment-header">
            ...
            <h4 class="payment-amount"><?php echo e(number_format($soTien, 0, ',', '.')); ?><sup>đ</sup></h4>
        </div>

        <div class="qr-wrapper">
            
            <img src="<?php echo e($qrUrl); ?>" alt="VietQR Code">
        </div>
        ...
        <ul class="instruction-list mt-4">
            ...
            <li>
                ...
                <span class="content">
                    ...
                    <strong><?php echo e($noiDungChuyenKhoan); ?></strong>
                </span>
            </li>
            <li>
        ...
        <hr>
        <a href="<?php echo e(route('sinhvien.quanly_dangky.index')); ?>" class="btn btn-outline-secondary">
...
<?php echo $__env->make('layouts.sinhvien', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/sinhvien/thanhtoan/qr.blade.php ENDPATH**/ ?>