...
<?php $__env->startSection('page_title', 'Chỉnh sửa học kỳ'); ?>
...
<div class="page-wrapper">
    ...
    <nav class="breadcrumb-modern">
        ...
        <span class="active">Chỉnh sửa: <?php echo e($hocky->TenHocKy); ?></span>
    </nav>
    ...
    <div class="form-card">
            ...
            <div class="form-card-header-content">
                <div class="form-card-title">
                    ...
                    <div class="form-card-title-text">
                        ...
                        <p>Cập nhật thông tin cho học kỳ: <?php echo e($hocky->TenHocKy); ?></p>
                    </div>
                </div>
        ...
        <div class="form-card-body">
            ...
            <form action="<?php echo e(route('admin.hocky.update', $hocky->MaHocKy)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" 
                               id="MaHocKy" 
                               name="MaHocKy" 
                               value="<?php echo e($hocky->MaHocKy); ?>"
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" 
                               id="TenHocKy" 
                               name="TenHocKy" 
                               value="<?php echo e(old('TenHocKy', $hocky->TenHocKy)); ?>"
                            ...
                            <?php if(isset($namhocs)): ?>
                                <?php $__currentLoopData = $namhocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($nh->MaNamHoc); ?>" 
                                        <?php echo e(old('MaNamHoc', $hocky->MaNamHoc) == $nh->MaNamHoc ? 'selected' : ''); ?>>
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="date" 
                               id="NgayBatDau" 
                               name="NgayBatDau" 
                               value="<?php echo e(old('NgayBatDau', $hocky->NgayBatDau)); ?>"
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="date" 
                               id="NgayKetThuc" 
                               name="NgayKetThuc" 
                               value="<?php echo e(old('NgayKetThuc', $hocky->NgayKetThuc)); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/admin/hocky/edit.blade.php ENDPATH**/ ?>