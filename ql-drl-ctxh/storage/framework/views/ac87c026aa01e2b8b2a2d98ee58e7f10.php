...
<?php $__env->startSection('title', 'Tạo Mã QR Check-Out DRL'); ?>
...
<div class="grid-container">
                ...
                <div class="qr-status-alert active">
                    ...
                    <div class="qr-status-alert-content">
                        ...
                        <div class="qr-status-alert-text">
                            <strong>Hiệu lực:</strong> <?php echo e($hoatdong_drl->CheckOutOpenAt->format('H:i - d/m/Y')); ?> 
    ...
    <div class="form-card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('nhanvien.hoatdong_drl.generate_checkout_qr', $hoatdong_drl)); ?>" method="POST">
                <?php echo csrf_field(); ?>
