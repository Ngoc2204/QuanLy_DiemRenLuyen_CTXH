...
<?php $__env->startSection('title', 'Hoạt Động Được Đề Xuất'); ?>
...
<div class="container-fluid" style="max-width:1200px;margin:0 auto;padding:2rem 1rem;">
    ...
    <?php $__empty_1 = true; $__currentLoopData = $recommendations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <?php if($activity): ?>
        <div class="recommendation-card <?php echo e(strtolower($rec->activity_type)); ?>-card">
            <div class="rec-header">
                <div class="rec-title">
                    <h5><?php echo e($activity->TenHoatDong); ?></h5>
                    <span class="rec-badge <?php echo e(strtolower($rec->activity_type)); ?>">
                        <?php echo e($rec->activity_type === 'drl' ? 'Rèn Luyện' : 'CTXH'); ?>

                    </span>
                </div>
                <div class="rec-score">
                    <?php echo e(round($rec->recommendation_score)); ?>/100
                </div>
            </div>
            ...
            <div style="margin: 1rem 0; padding: 1rem; background: #f8f9fa; border-radius: 8px; border-left: 4px solid var(--primary);">
                ...
                <p style="color: #555; margin: 0; line-height: 1.6;"><?php echo e($activity->MoTa); ?></p>
            </div>
            <?php endif; ?>
            ...
            <div style="margin: 0.75rem 0; padding: 0.75rem; background: #f1f5f9; border-radius: 8px;">
                ...
                <span style="margin-left: 0.5rem; color: #475569;"><?php echo e($activity->LoaiHoatDong); ?></span>
            </div>
            <?php endif; ?>
            ...
            <div class="row" style="margin-top: 1rem; font-size: 0.9rem;">
                <div class="col-md-6">
                    <div class="rec-meta">
                        ...
                        <span><strong>Bắt đầu:</strong> <?php echo e(optional($activity->ThoiGianBatDau)->format('d/m/Y H:i')); ?></span>
                    </div>
                    <div class="rec-meta">
                        <i class="fas fa-map-marker-alt"></i>
                        <span><strong>Địa điểm:</strong> <?php echo e($activity->DiaDiem); ?></span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="rec-meta">
                        <i class="fas fa-trophy"></i>
                        <span><strong>Điểm:</strong> +<?php echo e($activity->quydinh->DiemNhan ?? 0); ?></span>
                    </div>
                    <div class="rec-meta">
                        <i class="fas fa-users"></i>
                        <span><strong>Chỗ trống:</strong> <?php echo e($activity->SoLuong); ?> chỗ</span>
                    </div>
                </div>
            </div>
            ...
            <div class="rec-action">
                <?php if($rec->activity_type === 'drl'): ?>
                    <form action="<?php echo e(route('sinhvien.dangky.drl', $activity->MaHoatDong)); ?>" method="POST" style="flex: 1;">
                        <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    <form action="<?php echo e(route('sinhvien.dangky.ctxh', $activity->MaHoatDong)); ?>" method="POST" style="flex: 1;">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.sinhvien', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/sinhvien/activities_recommended/index.blade.php ENDPATH**/ ?>