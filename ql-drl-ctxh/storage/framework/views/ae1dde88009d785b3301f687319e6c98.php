                                ...
                                <tr <?php if($isDisabled): ?> class="table-secondary" <?php endif; ?>>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <select name="results[<?php echo e($pivot->MaDangKy); ?>][TrangThaiThamGia]" 
                                            ...
                                            <option value="Chưa tổng kết" <?php echo e($currentStatus == 'Chưa tổng kết' ? 'selected' : ''); ?>>⏳ Chưa tổng kết</option>
                                            <option value="Đã tham gia" <?php echo e($currentStatus == 'Đã tham gia' ? 'selected' : ''); ?>>✓ Đã tham gia</option>
                                            <option value="Vắng" <?php echo e($currentStatus == 'Vắng' ? 'selected' : ''); ?>>✗ Vắng</option>
                                        </select>
                                        <?php if($isDisabled): ?>
