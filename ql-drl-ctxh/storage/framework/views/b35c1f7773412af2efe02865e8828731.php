...
<?php $__env->startSection('title', 'Thêm lớp'); ?>
<?php $__env->startSection('page_title', 'Thêm lớp mới'); ?>
...
<div class="page-wrapper">
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            ...
            <!-- Form -->
            <form action="<?php echo e(route('admin.lop.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" 
                               id="MaLop" 
                               name="MaLop" 
                               value="<?php echo e(old('MaLop')); ?>"
                               class="form-control-modern <?php $__errorArgs = ['MaLop'];
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php if(isset($khoas)): ?>
                                <?php $__currentLoopData = $khoas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $khoa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($khoa->MaKhoa); ?>" <?php echo e(old('MaKhoa') == $khoa->MaKhoa ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/admin/lop/create.blade.php ENDPATH**/ ?>