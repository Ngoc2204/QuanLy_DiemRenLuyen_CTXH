...
<div class="page-header">
    <h4>
        ...
        <?php echo e($activity->TenHoatDong); ?>

    </h4>
    <div class="activity-code">
        <i class="fa-solid fa-barcode me-1"></i>
        Mã hoạt động: <?php echo e($activity->MaHoatDong); ?>
...
<?php if($sinhViens->isNotEmpty()): ?>
    ...
    <div class="stats-cards">
        <div class="stat-card">
            ...
            <div class="stat-card-value"><?php echo e($total); ?></div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-card-value"><?php echo e($checkedIn); ?></div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-card-value"><?php echo e($checkedOut); ?></div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-card-value"><?php echo e($pending); ?></div>
        </div>
    </div>
<?php endif; ?>
...
<form action="<?php echo e(route('nhanvien.' . $activityType . '.update_ket_qua', $activity)); ?>" method="POST">
    ...
    <div class="main-card">
                ...
                <table class="modern-table">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $sinhViens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $sv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <tr class="<?php echo e($isDisabled ? 'disabled-row' : ''); ?>">
                                ...
                                <td class="text-center">
                                    <?php if($pivot->TrangThaiDangKy == 'Đã duyệt'): ?>
                                        <span class="status-badge approved">
                                            <i class="fa-solid fa-circle-check"></i>
                                            <?php echo e($pivot->TrangThaiDangKy); ?>

                                        </span>
                                    <?php elseif($pivot->TrangThaiDangKy == 'Chờ duyệt'): ?>
                                ...
                                <td class="text-center">
                                    <?php if($pivot->CheckInAt): ?>
                                        <span class="time-badge checkin">
                                            ...
                                            <?php echo e(\Carbon\Carbon::parse($pivot->CheckInAt)->format('H:i')); ?>
                                ...
                                <td class="text-center">
                                    <?php if($pivot->CheckOutAt): ?>
                                        <span class="time-badge checkout">
                                            ...
                                            <?php echo e(\Carbon\Carbon::parse($pivot->CheckOutAt)->format('H:i')); ?>
                                ...
                                <td class="text-center">
                                    ...
                                    <select name="results[<?php echo e($pivot->MaDangKy); ?>][TrangThaiThamGia]" 
                                        ...
                                        <option value="Đã tham gia" <?php echo e($pivot->TrangThaiThamGia == 'Đã tham gia' ? 'selected' : ''); ?>>
                                            ✓ Đã tham gia
                                        </option>
                                        <option value="Vắng" <?php echo e($pivot->TrangThaiThamGia == 'Vắng' ? 'selected' : ''); ?>>
                                            ✗ Vắng
                                        </option>
                                        <option value="Chưa tổng kết" <?php echo e($pivot->TrangThaiThamGia == 'Chưa tổng kết' ? 'selected' : ''); ?>>
                                            ⏳ Chưa tổng kết
                                        </option>
                                    </select>
        ...
        <div class="action-bar">
            <a href="<?php echo e(route('nhanvien.' . $activityType . '.show', $activity)); ?>" class="btn-modern btn-back">
...
<?php echo $__env->make('layouts.nhanvien', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/nhanvien/hoatdong_ctxh/ghi_nhan_ket_qua.blade.php ENDPATH**/ ?>