...
<style>
    ...
    <div class="onboarding-card">
        ...
        <div class="onboarding-header">
            ...
            <h1>Chào mừng, <?php echo e($studentName); ?>!</h1>
        ...
        <!-- Form -->
        <form action="<?php echo e(route('sinhvien.onboarding.interests.store')); ?>" method="POST" id="interestsForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="interests-grid">
                <?php $__empty_1 = true; $__currentLoopData = $interests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $interest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="interest-item">
                        <input type="checkbox" 
                               id="interest_<?php echo e($interest->InterestID); ?>" 
                               name="interests[]" 
                               value="<?php echo e($interest->InterestID); ?>"
                               class="interest-checkbox"
                               data-interest-name="<?php echo e($interest->InterestName); ?>">
                        <label for="interest_<?php echo e($interest->InterestID); ?>" 
                               class="interest-label"
                               title="<?php echo e($interest->InterestName); ?>">
                            <?php if($interest->Icon): ?>
                                <i class="<?php echo e($interest->Icon); ?>"></i>
                            <?php else: ?>
                                <i class="bi bi-heart-fill"></i>
                            <?php endif; ?>
                            <span><?php echo e($interest->InterestName); ?></span>
                        </label>
                    </div>
...
<?php echo $__env->make('layouts.sinhvien', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/sinhvien/onboarding/select_interests.blade.php ENDPATH**/ ?>