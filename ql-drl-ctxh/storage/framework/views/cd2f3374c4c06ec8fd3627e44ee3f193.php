...
<?php $__env->startSection('page_title', 'Thông tin nhân viên'); ?>
...
<style>
    ...
    .page-wrapper {
        max-width: 900px;
        /* Tăng nhẹ độ rộng cho trang chi tiết */
        margin: 0 auto;
    }
            ...
            <div class="profile-card-header-content">
                <div class="profile-card-title">
                    <div class="profile-card-icon">
                        <!-- Avatar -->
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($nhanvien->TenNV)); ?>&background=fff&color=4f46e5&font-size=0.4&bold=true"
                            alt="Avatar của <?php echo e($nhanvien->TenNV); ?>">
                    </div>
                    <div class="profile-card-title-text">
                        <h1><?php echo e($nhanvien->TenNV); ?></h1>
                        <p>Mã NV: <?php echo e($nhanvien->MaNV); ?></p>
                    </div>
                </div>
        ...
        <div class="profile-card-body">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">
                        <?php echo $nhanvien->Email ? $nhanvien->Email : '<span class="empty">—</span>'; ?>
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">
                        <?php echo $nhanvien->SDT ? $nhanvien->SDT : '<span class="empty">—</span>'; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/admin/nhanvien/show.blade.php ENDPATH**/ ?>