...
<?php $__env->startSection('page_title', 'Bảng điều khiển hệ thống'); ?>
    ...
    <div class="stat-item">
        <div class="stat-card">
            <div class="card-body text-center p-3">
                ...
                <a href="<?php echo e(route('admin.sinhvien.index')); ?>" class="btn btn-sm btn-outline-primary mt-2">
    ...
    <div class="stat-item">
        <div class="stat-card">
            <div class="card-body text-center p-3">
                ...
                <div class="stat-value"><?php echo e(number_format($tongGiangVien)); ?></div>
    ...
    <div class="stat-item">
        <div class="stat-card">
            <div class="card-body text-center p-3">
                ...
                <div class="stat-value"><?php echo e(number_format($tongNhanVien)); ?></div>
                <a href="<?php echo e(route('admin.nhanvien.index')); ?>" class="btn btn-sm btn-outline-warning mt-2">
                    <i class="fa-solid fa-arrow-right me-1"></i>Xem chi tiết
                </a>
            </div>
        </div>
        ...
        <div class="chart-card">
            ...
            <div class="card-body p-3">
                <div class="stat-total">
                    ...
                    <div class="stat-value text-danger"><?php echo e(number_format($tongDRL)); ?></div>
                </div>
        ...
        <div class="chart-card">
            ...
            <div class="card-body p-3">
                <div class="stat-total">
                    ...
                    <div class="stat-value text-info"><?php echo e(number_format($tongCTXH)); ?></div>
                </div>
...
const drlTheoThang = <?php echo json_encode(array_values($drlTheoThang ?? array_fill(0, 12, 0))); ?>;
const ctxhTheoThang = <?php echo json_encode(array_values($ctxhTheoThang ?? array_fill(0, 12, 0))); ?>;
...
new Chart(ctxUsers, {
    ...
    data: {
        ...
        datasets: [{
            label: 'Số lượng',
            data: [
                <?php echo e($tongSinhVien ?? 0); ?>,
                <?php echo e($tongGiangVien ?? 0); ?>,
                <?php echo e($tongNhanVien ?? 0); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>