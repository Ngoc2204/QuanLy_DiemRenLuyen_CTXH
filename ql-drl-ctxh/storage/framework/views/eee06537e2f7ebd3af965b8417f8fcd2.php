...
<?php $__env->startSection('page_title', 'Thêm sinh viên mới'); ?>
...
<div class="page-wrapper">
    ...
    <div class="form-card">
        ...
        <div class="form-card-body">
            ...
            <!-- Form -->
            <form action="<?php echo e(route('admin.sinhvien.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group-modern">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text"
                            ...
                            class="form-control-modern <?php $__errorArgs = ['MSSV'];
                ...
                <div class="form-row-grid">
                    <div class="form-group-modern">
                        ...
                        <div class="input-wrapper">
                            ...
                            <select id="GioiTinh" name="GioiTinh" class="form-select-modern <?php $__errorArgs = ['GioiTinh'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group-modern">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" id="SDT" name="SDT" value="<?php echo e(old('SDT')); ?>" class="form-control-modern <?php $__errorArgs = ['SDT'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Ví dụ: 0987654321">
                            <?php $__errorArgs = ['SDT'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                ...
                <div class="form-row-grid">
                    ...
                    <div class="form-group-modern">
                        ...
                        <div class="input-wrapper">
                            ...
                            <select id="MaLop" name="MaLop" class="form-select-modern <?php $__errorArgs = ['MaLop'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="" disabled <?php echo e(old('MaLop') ? '' : 'selected'); ?>>-- Chọn lớp học --</option>
                                ...
                                <option value="<?php echo e($lop->MaLop); ?>" <?php echo e(old('MaLop') == $lop->MaLop ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group-modern">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" id="SoThich" name="SoThich"
                                value="<?php echo e(old('SoThich')); ?>"
                                class="form-control-modern <?php $__errorArgs = ['SoThich'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\HT_QuanLy_DRL_CTXH\ql-drl-ctxh\resources\views/admin/sinhvien/create.blade.php ENDPATH**/ ?>