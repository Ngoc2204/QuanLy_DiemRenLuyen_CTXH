...
<div class="container-fluid">
    <h4 class="my-4">Chỉnh sửa: <?php echo e($dotdiachido->TenDot); ?></h4>
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('admin.dotdiachido.update', ['dotdiachido' => $dotdiachido->id])); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="TenDot" name="TenDot"
                        value="<?php echo e(old('TenDot', $dotdiachido->TenDot)); ?>" required>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="NgayBatDau" name="NgayBatDau"
                                value="<?php echo e(old('NgayBatDau', \Carbon\Carbon::parse($dotdiachido->NgayBatDau)->format('Y-m-d'))); ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="NgayKetThuc" name="NgayKetThuc"
                                value="<?php echo e(old('NgayKetThuc', \Carbon\Carbon::parse($dotdiachido->NgayKetThuc)->format('Y-m-d'))); ?>" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="TrangThai" name="TrangThai">
                        <option value="SapDienRa" <?php echo e(old('TrangThai', $dotdiachido->TrangThai) == 'SapDienRa' ? 'selected' : ''); ?>>Sắp diễn ra</option>
                        <option value="DangDienRa" <?php echo e(old('TrangThai', $dotdiachido->TrangThai) == 'DangDienRa' ? 'selected' : ''); ?>>Đang diễn ra</option>
                        <option value="DaKetThuc" <?php echo e(old('TrangThai', $dotdiachido->TrangThai) == 'DaKetThuc' ? 'selected' : ''); ?>>Đã kết thúc</option>
                    </select>
                </div>
